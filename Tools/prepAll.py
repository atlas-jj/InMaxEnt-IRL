...
os.system("rm -rf -d ./"+image_folder+"/*.jpg")
...
print("3. please define delta sample gap, default 2:")
gap = 2
gap = int(input("Enter a number: "))

delta_sample_size = 0
for i in range(raw_sample_size-gap):
...
torch.save(samples, '/home/chris/fc/pyTorch_code/InMaxEnt_IRL_Pytorch/generate_dataset/'+task_name+'_'+dest+'_delta_samples_' + str(gap))
torch.save(samples_inverse, '/home/chris/fc/pyTorch_code/InMaxEnt_IRL_Pytorch/generate_dataset/'+task_name+'_'+ dest+ '_delta_samples_inverse_'+str(gap))
